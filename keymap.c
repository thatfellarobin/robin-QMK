...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_directional(
		...
		______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_BRIU, KC_VOLU, ______,
		______, ______, ______, ______, ______, ______, ______, ______, KC_BRID, KC_VOLD, ______),
