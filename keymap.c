...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_directional(
		...
		______, RGB_TOG, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
		______, ______, ______, ______, ______, ______, ______, ______, ______, KC_SLEP, ______, ______, ______,
		______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_BRMU, KC_AUDIO_VOL_UP, ______,
		______, ______, ______, ______, ______, ______, ______, TO(2), KC_BRMD, KC_AUDIO_VOL_DOWN, ______),
